...
public class ServiceErrorHandlerTest extends AbstractMongoIntegrationTest {
	...
	public void ServiceError_ShouldBeReturnedAsJson() throws Exception {
		...
		when(customerService.getAll()).thenThrow(new ServiceException(HttpStatus.BAD_REQUEST,
				Errors.createWithData("test").addData("data", "more data").get()));
